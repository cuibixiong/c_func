...
/*
 * This is printf. It can be called from any context. We want it to work.
 * 
 ...
 *
 * One effect of this deferred printing is that code which calls printf() and
